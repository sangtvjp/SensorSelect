package mysoft.co.jp.controller;
...
import mysoft.co.jp.ui.MainActivity;

public class ConnectBluetoothController extends Service {
    private final static String TAG = ConnectBluetoothController.class.getSimpleName();
    ...
    private void readData() {
        if (mGattCharacteristics != null) {
            BluetoothGattCharacteristic characteristic = mGattCharacteristics.get(currentData);
    ...
    private void parseData( BluetoothGattCharacteristic characteristic) {
        //final Intent intent = new Intent(ac);
        ...
        if (UUID_HEART_RATE_MEASUREMENT.equals(characteristic.getUuid())) {
            ...
            if (data != null && data.length > 0) {
                ...
                Log.d(TAG, "parseData: " + new String(data) + "\n" + stringBuilder.toString());
            }
        }
    }

    public class LocalBinder extends Binder {
        public ConnectBluetoothController getService() {
            return ConnectBluetoothController.this;
        }
    }
